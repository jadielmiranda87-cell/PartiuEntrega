...
Deno.serve(async (req: Request) => {
  ...
  try {
    ...
    // Como você não consegue criar a função payment-return no OnSpace,
    // usamos o mp-webhook como página de retorno do navegador (com ?mp=...),
    // e mantemos notification_url para o webhook server-to-server.
    ...
    const preference = {
      ...
      back_urls: {
        ...
        failure: `${returnBase}?mp=failed`,
        pending: `${returnBase}?mp=pending`,
      },
