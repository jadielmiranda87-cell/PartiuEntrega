  ...
  return (
    ...
    >
      ...
      >
            ...
            <View style={styles.contactBox}>
              <Text style={styles.contactText}>
                ...
                <Text
                  ...
                  onPress={() => Linking.openURL('mailto:partiuentrega@gmail.com')}
                >
                  partiuentrega@gmail.com
                </Text>
              </Text>
              ...
              <Text style={styles.contactText}>
                ...
                <Text
                  style={styles.contactEmail}
                  onPress={() => Linking.openURL('https://wa.me/5562994489336')}
                >
                  (62) 9 9448-9336
                </Text>
              </Text>
        ...
        {/* Register Options — only on login screen */}
        {screen === 'login' && (
...
const styles = StyleSheet.create({
  ...
  contactBox: { marginTop: Spacing.md, alignItems: 'center' },
  contactText: { color: Colors.textSecondary, fontSize: FontSize.xs, textAlign: 'center', lineHeight: 18 },
  contactEmail: { color: Colors.primary, fontWeight: '700' },
