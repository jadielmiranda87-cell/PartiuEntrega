...
export default function NewDeliveryScreen() {
  ...
  // ── Distance calculation (declared before applyGeocodeResult) ─────────────
  ...
  const applyGeocodeResult = useCallback((geo: GeocodeResult) => {
    ...
    setAddressSearch(geo.formatted_address || [street, number, city].filter(Boolean).join(', '));
